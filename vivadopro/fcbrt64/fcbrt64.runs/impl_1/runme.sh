...
HD_PWD='G:/FPU/r64_SRT_fcbrt/vivadopro/fcbrt64/fcbrt64.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fcbrt_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fcbrt_top.tcl -notrace
